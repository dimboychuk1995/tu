...
function dhtmlXGridCellObject(obj){
    ...
    this.getMathValue=function(){
        if (this.cell._val)return this.cell._val;else
    ...
    this.getHorAlign=function(){
        ...
        else if (this.cell.style.textAlign)return this.cell.style.textAlign;else
            return "left"
            };
...
Hashtable.prototype=new dhtmlXGridComboObject;//(c)dhtmlx ltd. www.dhtmlx.com
//v.2.5 build 91111
