...
<%
    ...
    try {
        ...
        String SQL = "DECLARE @date_registarion DATETIME = '"+date+"',"
                ...
                + "           @date_registarion<'30.11.2016'  THEN rate2015 "
                + "  WHEN @stage_join = 1 and @date_registarion >= '19.02.2016' then rate2016_Ist"
                + "  WHEN @stage_join = 2 and @date_registarion >= '19.02.2016' then rate2016_IIst"
                + "	 ELSE 0 "
                + "	 END AS rate "
