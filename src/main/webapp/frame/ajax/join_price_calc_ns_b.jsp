...
<% HttpSession ses = request.getSession();
    ...
    String ch_rez1 = new String();
    String ch_rez2 = new String();
    String SQL = null;
    ...
    try {
        ...
        while (rs.next()) {
            ch_rez1 = rs.getString("ch_rez1");
            ch_rez2 = rs.getString("ch_rez2");
        }
        //знаходимо резерв і в залежності від нього виконуємо деякий скрипт
        System.out.println(ch_rez1 + " " + ch_rez2 + "\n");
        System.out.println(ch_rez);
        System.out.println(ch_rez1.equals("TRUE"));
        System.out.println();


        if (!ch_rez1.equals("TRUE")) {
            SQL = ""
