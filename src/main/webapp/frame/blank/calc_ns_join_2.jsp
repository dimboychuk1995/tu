...
<% response.setHeader("Content-Disposition", "inline;filename=calc_ns_join_2.doc");
    ...
    try {
        ...
        String sql = "DECLARE @connection_price numeric(10,2),"
                ...
                + "               SET @connection_price =(SELECT CASE     WHEN @connection_price_temp<=15 THEN 1029.93  \n"
                + "                					  WHEN @connection_price_temp>15 AND @connection_price_temp<=150 THEN 1056.52  \n"
                + "                					  WHEN @connection_price_temp>150 AND @connection_price_temp<=500 THEN 1719.30  \n"
                + "                					  WHEN @connection_price_temp>500 AND @connection_price_temp<=10000 THEN 1840.68  \n"
                + "                					  ELSE 0 END) "
                + "SELECT   \n"
