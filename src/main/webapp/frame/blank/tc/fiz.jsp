...
%>
                ...
                <dt> 7. Розрахунковий облік електричної енергії: <strong><%= rs.getString("do3").replaceAll("7.2.", "</dt><dt>7.1.")%></strong>.<br> Придбання, встановлення та підключення приладів обліку електричної енергії  виконується РЕМ за рахунок абонента згідно вимог п.8 ПКЕЕН.<br>
                ...
                <dd> - Ввідний  комутаційний апарат  встановлювати з номінальними  даними згідно робочого проекту на електропостачання.</dd>
                ...
                <dt>9. Змонтувати  контур заземлення на <strong>ввідній опорі</strong> з опором заземлення не більше <strong>30 </strong>Ом.
                    Силова електро проводка виконується в трьох провідному виконанні. Виконати монтаж контуру заземлення з опором не білше 4 Ом. </dt>
