  ...
  <table width="100%">
    ...
    <tr>
      <td colspan="2">
        ...
        Споживач, з однієї сторони та АТ"Прикарпаттяобленерго", в особі директора філії <%=rs.getString("rem_name")%> РЕМ
    ...
    <tr>
      ...
      <tr>
          <td colspan="2">
              ...
              <u>Енергопостачальник :  АТ“Прикарпаттяобленерго” філія “<%=rs.getString("rem_name")%> РЕМ”.</u><br/>
