...
<%
    ...
    try {
        ...
        String qry = "SELECT "
                ...
                + ",isnull(nullif(TC_V2.[bank_account],''),'________________________') as [bank_account]"
                + ",isnull(nullif(TC_V2.[bank_mfo],''),'______________________') as [bank_mfo]"
                ...
                + ",[rek_bank] "
                + ",[rem_licality]"
                + ",isnull(convert(varchar,TC_O.date_contract,104),'___.___.____') as TC_Odate_contract "
                ...
                + "     when SUPPLYCH.join_point=1 then '1 напруга 110 кВ'"
    ...
    <body>
        <div class="Section1">
            ...
            <p align="center"><strong>Договір № <%= rs.getString("number")%></strong><br />
                <strong>про надання доступу до  електричних мереж будівельних електромеханізмів</strong></p>
            ...
            <div style="text-align:justify; text-indent:20pt"><strong>Публічне акціонерне товариство  «Прикарпаттяобленерго»</strong>, надалі ― <strong>
                ...
                директора  АТ «Прикарпаттяобленерго» <strong>Сеника Олега Степановича</strong>, який діє на підставі довіреності № 14 від 10.05.2017 року, з однієї сторони, та <strong><%if (!rs.getString("customer_soc_status_1").equals("9")
                ...
                далі ― Сторони, уклали цей  Договір на доступ електроустановок Замовника до електричних мереж ЕО (надалі ―  Договір).</div>
            <div style="text-align:justify; text-indent:20pt">При виконанні умов цього  Договору, а також вирішенні всіх питань, що не обумовлені цим Договором, сторони зобов'язуються
                ...
                містобудівної діяльності” та іншими нормативно-правовими актами. </div>
            <div style="text-align:justify; text-indent:20pt">Підписавши  цей Договір, Сторони підтверджують, що відповідно до законодавства та  установчих документів, мають право
                ...
                договору, наслідків його виконання та свідомо  бажають настання цих наслідків.</div>
            ...
            <dl style="text-align:justify">
                ...
                терміну дії договору про надання доступу <strong>№ <%= rs.getString("TC_Onumber")%> </strong>від<strong> <%= rs.getString("TC_Odate_contract")%>
                ...
                <dt>1.4 Клас напруги в точці підключення буде становити клас <%=rs.getString("joint_point")%>.</dt></dl>
            ...
            <dl>
                ...
                погодження проектної документації тощо) не відшкодовуються.</dt></dl>
            ...
            <dl style="text-align:justify">
                ...
                за місцем знаходження ЕО.</dt></dl>
            <p align="center"><strong>5 Строк дії Договору</strong></p>
            <dl style="text-align: justify">
                <dt>5.1 Цей Договір набирає чинності з моменту його підписання і  діє до закінчення терміну дії Договору про надання доступу до електричних мереж
                № <%=rs.getString("TC_Onumber")%> від <%=rs.getString("TC_Odate_contract")%> року.</dt>
                ...
                <dt>5.3 Договір може бути змінено або розірвано в односторонньому  порядку на вимогу ЕО у разі невиконання умов Договору про надання доступу до
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td><strong>_______________Сеник Олег Степанович</strong></td>
