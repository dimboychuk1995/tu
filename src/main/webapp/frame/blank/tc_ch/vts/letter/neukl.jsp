...
<html>
    ...
    <body>
        <div class="Section1">
            <p><strong><%= rs.getString("name")%></strong><br>
                <strong><u>п.<%= rs.getString("PIP")%> </u></strong><br>
            ...
            <p>&nbsp;</p>
            <p style="text-align:justify">ПАТ  «Прикарпаттяобленерго» надало Вам у <%= rs.getString("date_customer_contract_tc")%> року проект Договору про
                приєднання до електричних мереж №<%= rs.getString("number")%>. Відповідно до п. 1 ст. 645 Цивільного  Кодексу України, п. 3 ст. 181
                Господарського Кодексу України та п. 7.1 та 7.2  Договору Ви повинні були розглянути умови Договору та у
                двадцятиденний термін повернути  його на нашу адресу. У зв’язку з тим, що  ПАТ «Прикарпаттяобленерго»  у зазначений
                20-ти денний термін не одержало належним чином оформлений з Вашої  сторони Договір, або протоколу розбіжностей,
                даний Договір про приєднання вважається  неукладеним (таким, що не відбувся).</p>
            <p>&nbsp;</p>
            <p>З повагою,</p>
            <p>&nbsp;</p>
