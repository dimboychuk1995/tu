...
<html>
    ...
    <body>
        ...
        <p align="left"><br>
            ...
            <u>1. Джерело електропостачання: </u><em>(дисп. назва ПС, ТП;  номер опори, комірки) <u> ПС "<%= rs.getString("ps35110_name")%>",<%=rs.getString("type_source")%>-<%= rs.getString("ps10_name")%>=95                    </u></em><u> </u><br>
            ...
            1  Будівництво (реконструкція та/або технічне переоснащення) нових ТП , РП, ПС;  ПЛ, КЛ<em> (<strong>причини реконструкції</strong>, кількість, протяжність (від-до),  рекомендовані типи, конструктивне виконання,  технічні параметри): <strong><%=rs.getString("do1")%></strong></em><br>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td width="225" valign="top"><p>Інженер-керівник ВТГ</p>
                    <p>Майстер дільниці</p></td>
                <td width="225" valign="top"><p>&nbsp;</p></td>
                <td width="225" valign="top"><p>__________________________</p>
