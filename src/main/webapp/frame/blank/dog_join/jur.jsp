...
<html>
        ...
        <div class="Section1">
            ...
            <div align="justify" style="text-align:justify"><dl>
                    ...
                    <dt>3.1.5 Тривалість надання послуги зі стандартного приєднання може бути продовжена на строк необхідний для погодження та оформлення
                        ...
                        зокрема недопуск сторонніх осіб до виконання будівельно-монтажних робіт Виконавцем послугдо закону. Повідомлення власників
            ...
            <div align="justify" style="text-align:justify">
                <dl>
                    ...
                    <dt>4.2. Замовник сплачує плату за приєднання,визначену в пункті 4.1 цього Договору, на поточний рахунок Виконавця послуг: п/р 26000011732450 в філії Івано-Франківське обласне управління ПАТ «Укрсоцбанк», Код ЄДРПОУ 00131564</dt>
                    <dt>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="355" valign="top"><span><strong>Виконавець послуг :</strong></span></td>
            <td width="355" valign="top"><span><strong>Замовник:</strong></span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>________________        <%=rs.getString("Director")%><br>
                                                   <br>_____________________20___ року</td>
            <td>_______________       <%=rs.getString("PIP")%><br>
                                                   <br>_____________________20___ року</td>
        </tr>
    </table>
        </div>
