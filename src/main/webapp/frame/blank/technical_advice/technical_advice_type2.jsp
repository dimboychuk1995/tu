            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="2" class="par">
                        <p>
                            3.1.	 Розробити та погодити з ПАТ «Прикарпаттяобленерго» технічне завдання і проект на впровадження АСКОЕ підприємства згідно вимог діючої нормативно-технічної документації та державних стандартів України.<br/>
