...
<%  response.setHeader("Content-Disposition", "inline;filename=dod2.doc");
    ...
    <body>
        ...
        <div class="content">
            <table width="100%">
                ...
                <tr>
                    <td colspan="2" align="center" style="font-size: 100%"><b>АТ«ПРИКАРПАТТЯОБЛЕНЕРГО»<br/><br/></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" class="par">
                        <p>
                            3.1.	 Розробити та погодити з АТ«Прикарпаттяобленерго» технічне завдання і проект на впровадження АСКОЕ підприємства згідно вимог діючої нормативно-технічної документації та державних стандартів України.<br/>
                            3.2.	 Встановити проектною документацією наступні технічні параметри для АСКОЕ:<br/>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="par2">
                        ...
                        •	забезпечити можливості прямого доступу сервером АСКОЕ АТ«Прикарпаттяобленерго» до первинної бази даних (ПБД) розрахункових засобів обліку;<br/>
                        •	розрахунковий прилад обліку встановити в проектній ТП зі сторони 10кВ;<br/>
                        •	встановити прилади обліку на генераторах та на приєднаннях струмоприймачів власних потреб;<br/>
                        ...
                        •	умови спільного використання ЛУЗОД – регламент прямого доступу сервером АСКОЕ АТ«Прикарпаттяобленерго» до ПБД розрахункових засобів обліку в період з 00:30 до 08:00 годин кожної доби. Періодичність надсилання макетів щодобово до 08:00.<br/>

                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="par">
                        3.3.	 Встановити розрахункові засоби обліку електроенергії підприємства згідно проекту та відповідних розділів ПУЕ.<br/>
                        ...
                        3.6.	 Всі електричні кола приладу обліку електроенергії, лінії зв'язку ЛУЗОД або АСКОЕ, зборки затискачів у проводці до приладів обліку, вимірювальні трансформатори, що використовуються для розрахункових електролічильників, повинні бути забезпечені пристроями для пломбування і пломбуватися представниками АТ«Прикарпаттяобленерго».<br/>
                        3.7.	 Вимірювальні трансформатори  повинні бути повірені органами Держспоживстандарту і відповідати вимогам ПУЕ.<br/>
                        3.8.	 Ввести ЛУЗОД або АСКОЕ в дослідну експлуатацію з оформленням відповідного акту за підписом представника служби приладів обліку АТ«Прикарпаттяобленерго».<br/>
                        ...
                        3.11.	 Ввести ЛУЗОД або АСКОЕ в промислову експлуатацію з оформленням відповідного акту за підписом представника служби приладів обліку АТ«Прикарпаттяобленерго».<br/>
