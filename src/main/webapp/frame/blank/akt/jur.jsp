...
<% NumberFormat nf = NumberFormat.getInstance();
    ...
    try {
        c = ds.getConnection();
        String qry = "SELECT ISNULL(soc_status.name, '') AS customer_soc_status0, \n"
                + "       CASE  \n"
...
<html>
    ...
    <body>
        <p align="center"><strong>Акт</strong><br />
            ...
            Споживач  електроенергії: <strong><%if (!rs.getString("customer_soc_status_1").equals("8") && !rs.getString("customer_soc_status_1").equals("9") && !rs.getString("customer_soc_status_1").equals("10") && !rs.getString("customer_soc_status_1").equals("12") && !rs.getString("customer_soc_status_1").equals("11") && !rs.getString("customer_soc_status_1").equals("13")) {%><%= rs.getString("customer_soc_status0")%> <%= rs.getString("name")%><%} else {%><%=rs.getString("name")%><%}%>, <%= rs.getString("type_o")%><%= rs.getString("customer_adress")%></strong><br />
            в особі  <strong><%= rs.getString("PIP")%></strong><br />
            та <strong>філія ПАТ «Прикарпаттяобленерго» «<%= rs.getString("rem_name")%> РЕМ»</strong><br />
        ...
        <div align="justify" style="text-align:justify">
            <dl>
                ...
                <dt>Споживача: <strong> від вхідних клем вихідного комутаційного апарату приладу  обліку.</strong> <dt />
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="329" valign="top"><p><%if (!rs.getString("customer_soc_status_1").equals("11")
                            ...
                            && !rs.getString("customer_soc_status_1").equals("15")) {%><%= rs.getString("customer_soc_status0")%> <%= rs.getString("name")%><br/><%= rs.getString("customer_post")%><br/><%} else if (rs.getString("customer_soc_status_1").equals("15")) {%><%= rs.getString("customer_soc_status0")%><br/><br/><%} else {%><strong><%= rs.getString("name")%><br/><%= rs.getString("customer_post")%><br/><%}%>
                            <%= rs.getString("PIP")%>
                    </p>
                    М.П.
                </td>
