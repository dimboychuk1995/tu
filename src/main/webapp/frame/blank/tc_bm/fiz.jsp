    ...
    <body>
        <div class="Section1">
            ...
            <dl>
                ...
                <dt>14.  У випадку наявності існуючих ЛЕП в зоні забудови, винести їх з даної зони відповідно до технічного завдання, отриманого в філії «<%=rs.getString("rem_name")%>»</dt>
            </dl>
            <p>&nbsp;</p>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
