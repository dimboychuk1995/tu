...
<script type="text/javascript">
	...
	$(function() {
           	$(".datepicker").datepicker();
                ...
                $("#term_tc").change(function(){
                   enddata();
                     var b = $( "#date_contract" ).attr("value");
                    if(b!=''){
                        var temp = new Array();
                        temp = b.split('.');
                        var y=parseInt(temp[2])+parseInt($('#term_tc').attr("value"));
                        $( "#end_dohovoru_tu" ).attr("value",temp[0]+'.'+temp[1]+'.'+y);
                    }

                });
                $("#date_contract").change(function(){
                    enddata();
                    var b = $( "#date_contract" ).attr("value");
                    if(b!=''){
                        var temp = new Array();
  ...
  function enddata(){
    if($('#term_tc').attr("value")==0)
    {
        $( "#end_dohovoru_tu" ).datepicker();
        $( "#end_dohovoru_tu" ).attr('readonly',false);
    }else {
        $( "#end_dohovoru_tu" ).datepicker("destroy" );
        $( "#end_dohovoru_tu" ).attr('readonly',true);
    }
...
<table border="0">
   ...
   <tr>
    ...
    <tr>
        ...
        <td><html:text name="DetalViewActionForm" property="end_dohovoru_tu" size="10" styleId="end_dohovoru_tu" styleClass="tund"/></td>
    </tr>
    <tr>
