        ...
        <div class="container">
            <div class="row square_login">
                ...
                <div class="col-md-4">
                    ...
                    <p><a class="text-warning" href="../save_password.jsp">Якщо у вас проблеми з зберіганням паролю, перейдіть будь ласка за посиланням>>></a></p>
                </div>
                <div id="section-box">
                    <div class="col-md-8">
                        <html:form  action="/frame/login" styleId="form-login" style="clear: both;">
                            ...
                            <div class="button_holder">
                                <html:submit property="method" value="login" styleClass="btn btn-warning">Вхід</html:submit>
                            </div>
                        </html:form>
                    </div>
                </div>
