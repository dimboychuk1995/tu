...
<%  response.setHeader("Content-Disposition","inline;filename=info_ns_1.xls") ;
    Connection c = null;
    ...
    try {
        ...
        if (request.getParameter("number") == null) {
            pstmt = c.prepareStatement("{call dbo.[ZvitInfoN9NSJ_1]()}");
        } else {
...
<table border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td rowspan="2" align="center" valign="middle"  bgcolor="#CCCCCC">Назва об"єкта</td>
