...
<table width="76%" border="0" align="center">
    ...
    <tr>
        <td width="87%" align="center">про кількість виданих тухнічних умов за <u><%=request.getParameter("FromDate")%> - <%=request.getParameter("TillDate")%></u> та <br> з початку <u><%=request.getParameter("FromDate").substring(6)%></u> р. наростаючим підсумком<br>
...
<table border="1" cellspacing="0" cellpadding="0" align="center" class="tabl">
    <tr>
        ...
        <td colspan="2" align="center">Кількість виданих ТУ <br> побутовим споживачам філіями <br> шт. </td>
        <td colspan="2" align="center">Кількість виданих ТУ ВТП <br> шт.</td>
