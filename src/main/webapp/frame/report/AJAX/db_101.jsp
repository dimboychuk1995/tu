...
<%
    ...
    try {
        c = ds.getConnection();
        pstmt = c.prepareStatement("{call dbo.[ReceivedMoneyNotDefaultJoin](?,?)}");
...
<table width="76%" border="0" align="center">
    <tr>
        <td width="87%" align="center">Кошти, отримані за нестандартне приєднання з початку <u><%=request.getParameter("FromDate").substring(6)%></u> року та за період <u><%=request.getParameter("FromDate")%> - <%=request.getParameter("TillDate")%></u><br>
