...
<%
    ...
    try {
        c = ds.getConnection();
        pstmt = c.prepareStatement("{call dbo.[CostsBMRDefaultJoin](?,?)}");
...
<table width="76%" border="0" align="center">
    <tr>
        <td width="87%" align="center">Витрати згідно акту БМР з початку <u><%=request.getParameter("FromDate").substring(6)%></u> року та за період <u><%=request.getParameter("FromDate")%> - <%=request.getParameter("TillDate")%></u><br>
...
<table border="1" cellspacing="0" cellpadding="0" align="center" class="tabl">
    <tr>
        ...
        <td colspan="4" align="center">Витрачено коштів згідно акту виконаних робіт + проект, грн</td>
        <td colspan="4" align="center">Перевитрати, грн</td>
    </tr>
    <tr>
