...
<%  response.setHeader("Content-Disposition", "inline;filename=vkb_nestandartne.xls");
    Connection c = null;
    ...
    try {
        ...
        if (request.getParameter("number") == null) {
            pstmt = c.prepareStatement("{call dbo.ZvitVKB_nsj()}");
        } else {
...
<table width="100%" border="1" align="center">
    <thead>
        <tr>
            ...
            <td align="center" bgcolor="#CCCCCC" rowspan="3">Вартість реконструкції будівництва ЛЕП, грн.</td>
            <td align="center" bgcolor="#CCCCCC" rowspan="3">Капітальні витрати на будівництво (реконструкцію) підстанції, грн</td>
