...
<%  response.setHeader("Content-Disposition", "inline;filename=vkb_standartne.xls");
    Connection c = null;
    ...
    try {
        ...
        if (request.getParameter("number") == null) {
            pstmt = c.prepareStatement("{call dbo.ZvitVKB()}");
        } else {
...
<table width="100%" border="1" align="center">
    <thead>
        <tr>
            ...
            <td rowspan="3" align="center" valign="middle"  bgcolor="#CCCCCC">Довжина будівництва/реконструкції ЛЕП 10(6) кВ, км</td>
        </tr>
        <tr>
