...
<![endif]-->
    ...
    <body>
        ...
        <div class="modal-1 reloadDatabase">
            <script type="text/javascript">
                alert("Увага, я зв*язку з зменшенням швидкодії бази ТУ, через переповнення даними, кожного дня" +
                "буде проводитись планове перезавантаження бази в 12:45, просимо в даний час не працювати в базі" +
                "напротязі 5хв, та зберегти всі свої попередні зміни для запобігання видалення даних. " +
                "                               База буде перезавантажена в 12:45");
            </script>
        </div>
