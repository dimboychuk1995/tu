...
<% NumberFormat nf = NumberFormat.getInstance();
    ...
    try {
        ...
        String qry = "SELECT "
                ...
                + ",isnull(convert (varchar(15),dbo.TC_V2.date_pay_join,104),'___.___.____') as date_pay_join"
...
<html>
    <head>
        ...
        <jsp:include page="../newtemplate.jsp"/></head>
    <body>
        <p align="center"><strong>Заявка на  проектування та будівництво  згідно</strong><br>
        ...
        <div align="justify" style="text-align:justify">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="347" valign="top">
                        <span class="style1">Встановлена потужність електронагрівальних установок:</span></td>
            ...
            <dt align="justify">5. <strong>Напруга в точці приєднання: </strong><%= rs.getString("joint_point").replace(".", ",")%> кВ.</dt>
            <dt align="justify">6. <strong>Джерело електропостачання: </strong> <%//do {
...
%>
            ...
            <dt><strong>11. Орієнтовні терміни завершення робіт: </strong><%=rs.getString("term_for_joining")%> днів(день).</dt>
            <dt><strong>12. Схема приєднання (у випадку необхідності):</strong></dt>
            <dt>&nbsp;</dt>
            <dt>&nbsp;</dt>
            <dt>&nbsp;</dt>
            <dt>&nbsp; </dt>
        </div>
        <p align="center"><strong>Підготував  інженер ВТП    </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                            _____________________________</p>
