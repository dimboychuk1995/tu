...
<html>
    ...
    <body>
        ...
        <table border="0" cellspacing="0" cellpadding="0" align="right" width="321">
            <tr>
            ...
            <tr>
                <td width="321" valign="bottom"><p align="center"><%=rs.getString("customer_post")%> <%=rs.getString("PIP")%> &nbsp;</p></td>
            </tr>
            <tr>
                <td width="321" valign="bottom"><p align="center"><%=rs.getString("customer_soc_status")%> "<%=rs.getString("name")%>" &nbsp;</p></td>
            </tr>
            <tr>
                <td width="321" valign="top"><p align="center">Банківські    Реквізити </p></td>
            </tr>
            <tr>
                <td width="321" valign="top"><p>Код <%=rs.getString("bank_identification_number")%> </p></td>
            </tr>
            <tr>
                <td width="321" valign="top"><p>р/р: <%=rs.getString("bank_account")%></p></td>
            </tr>
            <tr>
                <td width="321" valign="top"><p>Банк:   </p></td>
            </tr>
            <tr>
                <td width="321" valign="top"><p>МФО <%=rs.getString("bank_mfo")%> </p></td>
            </tr>
            <tr>
                <td width="321" valign="top"><p>Свідоцтво платника ПДВ № </p></td>
            </tr>
            <tr>
        ...
        <h1 align="right">&nbsp;</h1>
        <br clear="ALL">
        <p align="center">_________________&nbsp;                      _________________               <%=rs.getString("customer_soc_status")%> <%=rs.getString("name")%>       <br>
            (дата)                                                    (підпис)                                                         (М. П.)</p>
        <h1 align="center">&nbsp;</h1>
    </body>
