...
<% response.setHeader("Content-Disposition", "inline;filename=jur.doc");
    ...
    try {
        ...
        String SQL = ""
                ...
                + "       Isnull(TC_V2.taxpayer, '')                        AS taxpayer, "
...
<html>
    ...
    <body>
        ...
        <p align="right">Директору<br> філії &quot;<%=rs.getString("rem_name")%> РЕМ&quot;<br>ПАТ "Прикарпаттяобленерго"<br/><%=rs.getString("director_dav")%></p>
        <div align="center"><strong>ЗАЯВА</strong><br>
            <strong>про приєднання електроустановки певної потужності</strong><br></div>
        <div align="center"><u><%if (!rs.getString("customer_soc_status_1").equals("9")
                    && !rs.getString("customer_soc_status_1").equals("12")) {%> <%= rs.getString("customer_soc_status")%><%}%> 
                <%= rs.getString("name")%></u><br>
            <u>Свідоцтво платника податків №<%=rs.getString("taxpayer")%></u><br>
            ...
            <u>п/р <%=rs.getString("bank_account")%><%=rs.getString("bank_mfo")%></u>, <br>
            <span class="стиль3">(банківські реквізити замовника)*</span><br />
        ...
        <div align="center">  <u><%=rs.getString("date_intro_eksp").replace("-1", "_______")%></u><br>
            <span class="стиль3">(прогнозований рік уведення об’єкта в експлуатацію)*</span><br>
            ________________________________________________________________<br>
            <span class="стиль3">(режим роботи електроустановок)</span><br>
            __________________________________________________________________<br>
            <span class="стиль3">(відомості щодо встановленої потужності електроопалювальних установок  та кухонних електроплит)</span><br>
