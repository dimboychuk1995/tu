        ...
        <div class="Section1">
            ...
            <p align="left"><br>
                ...
                <strong><u>ІІІ. Орієнтовні обсяги робіт для  передачі потужності до точки приєднання (роботи, які необхідно виконати в  мережах ПАТ&nbsp;&quot;Прикарпаттяобленерго&quot;):
                        <%=rs.getString("do1")%>  </u></strong><br>
                1  Будівництво (реконструкція та/або технічне переоснащення) нових ТП , РП, ПС;  ПЛ, КЛ<em> (<strong>причини реконструкції</strong>
                    , кількість, протяжність (від-до),  рекомендовані типи, конструктивне виконання,  технічні параметри):<strong>
                            <%=rs.getString("do1").replaceAll("7.2.", "</dt><dt>1.")%></strong></em><br>
            ...
            <dl>
                ...
                <dt><strong><%=rs.getString("do2").replaceAll("7.2.", "</dt><dt>1.")%></strong></dt>
                <dt>2. по влаштуванню розрахункового обліку  електроенергії:</dt>
                <strong><%=rs.getString("do3").replaceAll("7.2.", "<br>")%></strong>
            </dl>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="225" valign="top">Інженер-керівник ВТГ</td>
                ...
                <tr>
                    ...
                    <td width="225" valign="top"><p>&nbsp;</p></td>
                    <td width="225" valign="top">__________________________</td>
                </tr>
            </table>
            <br clear="all">
            <p align="right"><strong>7.5.1-ПР-1-ТД-1.4 Ж</strong></p>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="218" valign="top"><p>Головний інженер</p></td>
                    <td width="225" valign="top"><p>&nbsp;</p></td>
                    <td width="225" valign="top"><p><%=rs.getString("golovnyi_ingener")%></p></td>
                </tr>
                <tr>
