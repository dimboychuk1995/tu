...
<%
    ...
    try {
        ...
        String qry = "SELECT "
                ...
                + ",isnull (cast(ps10.ps_nav as numeric (10,2)),0.00) as ps10_nav "
                ...
                + " ,(SELECT top 1 cast( "
                + " 	(select((isnull([ps_nom_nav],0)+isnull([ps_nom_nav_2],0))*0.92)-isnull([ps_nav],0) from [TUweb].[dbo].[ps_tu_web] where ps_id=ps10.ps_id)- "
...
<html>
    ...
    <body>
        <div class="Section1">
            ...
            <h5 align="center">Вихідні дані та пропозиції  філії <%=rs.getString("rem_name")%> РЕМ<br>
                <strong>по приєднанню електроустановок  Замовників до електричних мереж</strong></h5>
            <p align="left">
                ...
                <u>в т. ч. існуюча (договірна)  потужність <strong><%= rs.getString("power_old")%></strong><em> кВт</em> ,  категорія з надійності  електропостачання (ІІІ)</u><br>
                ...
                <u>1. Джерело електропостачання: </u><em>(дисп. назва ПС, ТП;  номер опори, комірки) <u> ПС "<%= rs.getString("ps35110_name")%>",<%=rs.getString("type_source")%>-<%= rs.getString("ps10_name")%>                    </u></em><u> </u><br>
                <u>2. Точка приєднання: </u><em>існуюча  (дисп. назва) –</em><strong><%= rs.getString("connection_treaty_number")%> </strong><br>
                <em>проектна  (дисп. назва) – </em><br>
                ...
                1  Будівництво (реконструкція та/або технічне переоснащення) нових ТП , РП, ПС;  ПЛ, КЛ<em> (<strong>причини реконструкції</strong>, кількість, протяжність (від-до),  рекомендовані типи, конструктивне виконання,  технічні параметри): <strong><%=rs.getString("do1").replaceAll("7.2.", "</dt><dt>1.")%></strong></em><br>
                2 Орієнтовна однолінійна схема  <strong><em>(заповнюється обов’язково)</em></strong>:<br>
            </p>
            <dl>
                <dt>
                    <br>
                    <br>
                    <strong><u>ІV. Орієнтовні обсяги робіт для  передачі потужності від точки приєднання до Замовника:</u></strong><br>
                    1  Будівництво (реконструкція та/або технічне переоснащення) нових ТП , РП, ПС;  ПЛ, КЛ<em> (<strong>причини реконструкції</strong>, кількість, протяжність (від-до),  рекомендовані типи, конструктивне виконання,  технічні  параметри): </em></dt>

                <dt><strong><%=rs.getString("do2").replaceAll("7.2.", "<br>")%></strong></dt>
                <dt>2. по влаштуванню розрахункового обліку  електроенергії:</dt>
            </dl>
            <dt><strong><em><%=rs.getString("do3").replaceAll("7.2.", "<br></dt><dt>")%></em></strong><strong><br></strong>
          ...
          <strong><em>- У  випадку встановлення багатотарифного приладу обліку та неможливості  застосування приладу обліку  з функцією  обмеження максимального споживання потужності, встановити ПЗР . Номінальний  струм ПЗР визначити проектом. Тип лічильника визначити проектом та погодити в  заступника по енергонагляду</em></strong><strong>;</strong> </p>--%>
            <dl style="line-height: 150%">
                <dt>3. по компенсації реактивної потужності ––</dt>
                <dt>4. по влаштуванню пристроїв захисту –– ПЗВ </dt>
                <dt>5. по дотриманню охоронних зон електромереж –– згідно ПВЕЕ </dt>
            </dl>
            <table border="0" cellspacing="0" cellpadding="0" style="line-height: 150%">
                <tr>
                    <td width="225" valign="top"><p>Головний інженер</p></td>
                    <td width="225" valign="top"><p>&nbsp;</p></td>
                    <td width="225" valign="top"><p><%=rs.getString("golovnyi_ingener")%></p></td>
                </tr>
                <tr>
                    <td width="225" valign="top"><p>Заступник директора РЕМ</p></td>
                    <td width="225" valign="top"><p>&nbsp;</p></td>
                    <td width="225" valign="top"><p>__________________________</p></td>
                </tr>
                <tr>
                    <td width="225" valign="top"><p>Інженер-керівник ВТГ</p>
                    <td width="225" valign="top"><p>&nbsp;</p></td>
                    <td width="225" valign="top"><p><%=rs.getString("vykonavets")%></p></td>
                </tr>
                <tr>
                    <td width="225" valign="top"> Майстер дільниці</td>
                    <td width="225" valign="top"><p>&nbsp;</p></td>
                    <td width="225" valign="top"><p>__________________________</p></td>
                </tr>
            </table>
            ...
            <table border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td width="312" colspan="3" valign="top" align="center"><strong><%=rs.getString("customer_soc_status")%> <%=rs.getString("name")%>,
                            <%=rs.getString("type_c")%> <%=rs.getString("customer_adress")%></strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65" valign="top" align="center"><%=rs.getString("fid_04_leng")%>&nbsp;</td>
                    <td width="188" valign="top">&nbsp;</td>
                </tr>
            </table>
