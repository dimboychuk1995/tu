...
<%
    ...
    try {
        ...
        String qry = "SELECT "
                ...
                + ",case when ps35.ps_name like '' or ps35.ps_name is null "
                + "            then isnull(cast(ps110.max_strum as varchar),'') "
                + " else isnull(cast(ps35.max_strum as varchar),'') end as max_strum "
...
$(document).ready(function(){
   <%if (rs.getString("reliabylity_class_1").equals("false")){%>$('.k1').hide(3000);
        <%} else {%>$('.k1').show();<%}%>
   <%if (rs.getString("reliabylity_class_2").equals("false")){%>$('.k2').hide(3000);
        <%} else {%>$('.k2').show();<%}%>
});
    ...
    <body>
        <div class="Section1">
            ...
            <p align="center">&nbsp;<span class="style1">ПАТ «ПРИКАРПАТТЯОБЛЕНЕРГО»</span></p>
            <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="font-size: 11pt">
                <tr>
                    ...
                    <td width="70%" valign="top"><p align="left" class="style1"><%=rs.getString("rem_licality")%></p>
                        <p class="style1">На № <%=rs.getString("no_zvern")%> від <%=rs.getString("registration_date")%> р. </p>
            ...
            <p align="center"><span class="style1"><strong>ТЕХНІЧНІ УМОВИ № <%= rs.getString("number")%></strong><br>
                    на приєднання будівельних струмоприймачів <br>
                </span><br>
            </p>
            <div align="right">Додаток 1<br>
                до договору про надання доступу будівельних струмоприймачів<br>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="328" valign="top">М.П.
                <br>Технічний директор ПАТ «Прикарпаттяобленерго»<br>
        ...
        <tr>
            ...
            <p class="style2">Виконав:
                <bean:write name="loginActionForm" property="PIP"/>
                <br>
                <bean:write name="loginActionForm" property="tel_number"/>
            </p>
        </div>
    </body>
