...
<% response.setHeader("Content-Disposition", "inline;filename=calc_ns_join_2.doc");
    ...
    try {
        ...
        String sql = "DECLARE @connection_price numeric(10,2),"
                ...
                + "               SET @connection_price =(SELECT CASE     WHEN @connection_price_temp<=15 THEN 1035.05  \n"
                + "                					  WHEN @connection_price_temp>15 AND @connection_price_temp<=150 THEN 1061.64  \n"
                + "                					  WHEN @connection_price_temp>150 AND @connection_price_temp<=500 THEN 1724.42  \n"
                + "                					  WHEN @connection_price_temp>500 AND @connection_price_temp<=10000 THEN 1845.80  \n"
                + "                					  ELSE 0 END) "
                + "SELECT   \n"
