...
<html xmlns:w="urn:schemas-microsoft-com:office:word">
    ...
    <body>
        <div class="Section1">
            ...
            <p style="text-align:justify;text-indent:20pt"><strong>ПАТ “Прикарпаттяобленерго”,</strong> що&nbsp; діє за  умовами та правилами Ліцензії АБ № 177333 (далі – <%=rs.getString("executor_template")%>), в особі технічного директора ПАТ  «Прикарпаттяобленерго» Сеника Олега Степановича, який діє на підставі  довіреності № 816 від 11.08.2014 року, з однієї сторони,  та  <strong><%if (!rs.getString("customer_soc_status_1").equals("9")
                                && !rs.getString("customer_soc_status_1").equals("12")) {%><%= rs.getString("customer_soc_status")%><%}%> <%= rs.getString("name")%></strong>, надалі ― <strong>Замовник</strong>, <%if ((!rs.getString("customer_soc_status_1").equals("15")
...
%>
    ...
    <div class="Section1"><font size="-1">
            ...
            <div style="text-align:justify; text-indent:20pt"><font size="-1"><strong>Публічне акціонерне товариство «Прикарпаттяобленерго»</strong>,&nbsp;надалі ―
                    ...
                    <strong>653</strong>&nbsp;від&nbsp;<strong>29.03.2013</strong>
