...
<html>
    ...
    <body>
        <div class="Section1">
            ...
            <p>&nbsp;</p>
            <p style="text-align:justify">АТ «Прикарпаттяобленерго» надало Вам у <%= rs.getString("date_customer_contract_tc")%> року проект Договору про
                ...
                двадцятиденний термін повернути  його на нашу адресу. У зв’язку з тим, що  АТ«Прикарпаттяобленерго»  у зазначений
