...
<html>
    ...
    <body>
        <div class="Section1">
            ...
            АТ «Прикарпаттяобленерго»  розглянуло Ваше звернення щодо продовження терміну дії технічних умов № <%= rs.getString("number")%> від <%= rs.getString("date_contract")%> на електропостачання <%= rs.getString("object_name")%> та повідомляє наступне. Термін дії технічних  умов № <%= rs.getString("number")%> від <%= rs.getString("date_contract")%> вже закінчився, тому дані технічні умови  вважаються такими, що втратили свою чинність. <br>
            Враховуючи вищезазначене, для отримання нових технічних умов Вам потрібно  звернутися у філію «<%= rs.getString("rem_name")%> РЕМ» АТ «Прикарпаттяобленерго» (<%= rs.getString("rem_licality")%>) із  наступними документами: <br>
            ...
            12. У випадку, коли майно знаходиться у спільній власності  кількох осіб, то необхідно отримати письмове доручення всіх співвласників про  те, що вони доручають або не заперечують відповідному Замовнику укласти договір  про надання доступу до електричних мереж АТ «Прикарпаттяобленерго»</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
