...
<div class="Section1">
    ...
    <div class="Section1">
        ...
        <div align="justify" style="text-align:justify">
            <dl>
                <dt>4.1. Плата за приєднання за цим Договором відповідно  до Постанови НКРЕ № 3019 від 22.12.2016 «Про затвердження ставок плати за приєднання електроустановок для Автономної Республіки Крим, областей, міст Києва та Севастополя на 2015 рік», становить <strong>  <%= rs.getString("price_join").replace(".", ",")%></strong> грн. з ПДВ.</dt>
