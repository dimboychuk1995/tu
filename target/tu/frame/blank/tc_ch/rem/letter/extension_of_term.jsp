...
<html>
    ...
    <body>
        ...
        <div  style="text-align:justify; text-indent:20pt"><%= rs.getString("date_customer_contract_tc")%> року між Вами та ПАТ «Прикарпаттяобленерго» укладено Договір про приєднання до електричних мереж № <%= rs.getString("number")%>. Трасу проходження запроектованих мереж зовнішнього електропостачання для  приєднання Ваших електроустановок до мереж ПАТ, необхідно погодити з власниками  земельних ділянок по яких вони проходять. _______ року філія ПАТ «Прикарпаттяобленерго» «<%= rs.getString("rem_name")%> РЕМ» звернулася листом вих. № _______ до власника земельної ділянки __________________ із проханням в термін до _____ календарних  днів погодити та повернути у філію проект електропостачання зовнішніх електричних мереж.</div>
