...
<html>
    ...
    <body>
        <div class="Section1">
            ...
            <p>&nbsp;</p>
            <p>Філія  ПАТ «Прикарпаттяобленерго» «<%= rs.getString("rem_name")%> РЕМ» надала Вам у <%= rs.getString("date_customer_contract_tc")%> року
                ...
                повернути його на нашу адресу. У зв’язку з тим, що  ПАТ «Прикарпаттяобленерго» у зазначений 20-ти  денний термін не одержало належним чином
