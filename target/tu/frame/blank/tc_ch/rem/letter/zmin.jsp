...
<html>
    ...
    <body>
        <div class="Section1">
            <table><tr><td><u><%=rs.getString("name")%></u></td></tr>
            ...
            <p>1. <strong><u><%= rs.getString("Description_change")%></u></strong></p>
            <p><strong>&nbsp;</strong></p>
            <p><strong>&nbsp;</strong></p>
            <table>
                <tr><td>Директор філії </td></tr>
                <tr><td><%= rs.getString("rem_name")%> РЕМ</td></tr>
                <tr><td><u><%=rs.getString("Director")%></u></td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td><u>Виконавець: <%=rs.getString("vykonavets")%></u></td></tr>
                <tr><td><u><%=rs.getString("contacts")%></u></td></tr>
            </table>
        </div>
    </body>
