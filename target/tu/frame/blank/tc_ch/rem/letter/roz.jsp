    ...
    <body>
        <div class="Section1">
            ...
            <p style="text-align:justify; text-indent:20pt">
                Між АТ«Прикарпаттяобленерго» та <%=rs.getString("customer_soc_status")%> <%=rs.getString("name")%> укладено Договір № <%=rs.getString("number")%> від <%=rs.getString("date_contract")%>р.  про приєднання до електричних мереж. У відповідності до додатку № 2 Договору, Ви зобов’язані здійснити плату за приєднання до _________року ________грн.
                Станом на ________р. Вами не здійснено оплату згідно умов даного Договору. Відповідно до п. 6.3 Договору про приєднання до електричних мереж Договір може бути змінено або розірвано на вимогу Власника (АТ“Прикарпаттяобленерго”) у разі порушення Замовником термінів здійснення плати за приєднання.
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>Виконавець<u><%=rs.getString("vykonavets")%></u></p>
            <p>тел.<u><%=rs.getString("contacts")%></u></p>
        </div>
    </body>
