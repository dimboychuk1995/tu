...
%>
            ...
            <div align="justify" style="text-align:justify">
                <dl>
                    ...
                    <dt><strong>У випадку приєднаної потужності більше 150 кВт та встановленні ТП -10/0,4 кВ, яке
                        залишається в мережах Замовника, для організації комерційного обліку передбачити
                        встановлення засобів ЛУЗОД</strong></dt>
