...
%>
            ...
            <div align="justify" style="text-align:justify">
                <dl>
                    ...
                    <dt>3  У випадку наявності існуючих ЛЕП в зоні забудови, винести їх з даної зони відповідно до технічного завдання, отриманого в філії «<%=rs.getString("rem_name")%>»</dt>
                </dl>
            </div>
            <p><br>
            </p>
